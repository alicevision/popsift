...
#ifdef USE_DOG_ARRAY
__device__
bool find_extrema_in_dog_v4_sub( cudaTextureObject_t dog,
                                   int                 level,
                                   int                 width,
                                   int                 height,
                                   float               edge_limit,
...
#else // not USE_DOG_ARRAY
__device__
bool find_extrema_in_dog_v4_sub( Plane2D_float&     dog0,
                                   Plane2D_float&     dog1,
                                   Plane2D_float&     dog2,
                                   float              edge_limit,
                                   float              threshold,
                             ...
                             ExtremumCandidate*  d_extrema )
{
    ...
    bool indicator = find_extrema_in_dog_v4_sub( dog, level, width, height, edge_limit, threshold, maxlevel, ec );
                             ...
                             ExtremumCandidate* d_extrema )
{
    ...
    bool indicator = find_extrema_in_dog_v4_sub( dog_upper, dog_here, dog_lower, edge_limit, threshold, level, maxlevel, ec );
