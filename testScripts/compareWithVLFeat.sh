...
run_vlfeat() {
    ...
    awk -f compute.awk tmp/${file}-vlfeat.sift > tmp/sum-${file}-vlfeat.txt
    echo "LEAVE VLFEAT"
}
...
run_popsift() {
    ...
    awk -f compute.awk tmp/${file}-popsift.sift > tmp/sum-${file}-popsift.txt
    echo "LEAVE POPSIFT"
}
...
do
	...
	awk -vCOL=3  -f desc-to-heat.awk tmp/descdist-${file}-${TESTNAME}.txt >  descdist-${file}-${TESTNAME}.txt
	awk -vCOL=4  -f desc-to-heat.awk tmp/descdist-${file}-${TESTNAME}.txt >> descdist-${file}-${TESTNAME}.txt
	awk -vCOL=5  -f desc-to-heat.awk tmp/descdist-${file}-${TESTNAME}.txt >> descdist-${file}-${TESTNAME}.txt
	awk -vCOL=6  -f desc-to-heat.awk tmp/descdist-${file}-${TESTNAME}.txt >> descdist-${file}-${TESTNAME}.txt
	awk -vCOL=7  -f desc-to-heat.awk tmp/descdist-${file}-${TESTNAME}.txt >> descdist-${file}-${TESTNAME}.txt
	awk -vCOL=8  -f desc-to-heat.awk tmp/descdist-${file}-${TESTNAME}.txt >> descdist-${file}-${TESTNAME}.txt
	awk -vCOL=9  -f desc-to-heat.awk tmp/descdist-${file}-${TESTNAME}.txt >> descdist-${file}-${TESTNAME}.txt
	awk -vCOL=10 -f desc-to-heat.awk tmp/descdist-${file}-${TESTNAME}.txt >> descdist-${file}-${TESTNAME}.txt
