...
int main(int argc, char** argv)
{
    ...
    dataset = read_points("C:/TEMP/dataset.dat", rows, cols);
    printf("Reading test data file.\n");
    testset = read_points("C:/TEMP/testset.dat", tcount, cols);
    ...
    write_results("C:/TEMP/results.dat",result, tcount, nn);
